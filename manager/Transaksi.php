<?php 
      ...
      if (isset($_GET['id'])) {
            $id = $_GET['id'];
            $dataDetail = $trs->edit("detailTransaksi","kd_pembayaran",$id);
            $total  = $trs->selectSumWhere("transaksi","","kd_transaksi='$id'");
            $jumlah_barang = $trs->selectSumWhere("transaksi","kd_p","kd_transaksi='$id'");
      }
?>
<style>
      .col-sm-12{
