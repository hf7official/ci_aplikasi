<?php 
    ...
    if($lg->sessionCheck() == "true"){
        ...
        }else if($_SESSION['level'] == "manager keuangan"){
...
<body style="background: url(images/bgrd.jpg) no-repeat; background-size: cover;">
                ...
                <div class="login-wrap">
                    <div class="login-content">
                        <div class="login-logo">
                            <a href="#">
                                <img src="images/icon/tri.png" alt="PT. TRIAGRAMA">
                            </a>
                        </div>
