<?php 
    ...
    class lsp{
        ...
        public function selectBetween($table,$whereparam,$param,$param1){
            ...
            $sqls = "SELECT SUM() as count FROM $table WHERE $whereparam BETWEEN '$param' AND '$param1'";
            ...
            return ['data'=>$data,'kd_pebayaran'=>$assocs];
        }
        ...
        public function register($kd_user,$name,$username,$password,$confirm, $foto, $level,$redirect){
            ...
            if($rows == 0){
                ...
                if($password == $confirm){
                    ...
                    $sql = "INSERT INTO user VALUES('$kd_user','$name','$username','$password','$response[image]', '$level')";
                    $query   = mysqli_query($con,$sql);
                    if($query){
