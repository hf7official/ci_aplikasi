                ...
                <div class="col-md-12">
                    <form method="post" enctype="multipart/form-data">
                        ...
                        <div class="au-card-title" style="background-image:url('images/bg-title-01.jpg');">
                            ...
                            <h3>
                            <i class="zmdi zmdi-account-calendar"></i>Input Jadwal Proyek</h3>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Nama Proyek" class="form-control" name="nama_barang" value="<?php echo @$_POST['nama_barang'] ?>">
                                </div>
                                <div class="form-group">
