...
<body>
	...
	<div class="page-wrapper">
		<aside class="menu-sidebar2">
			<div class="logo">
                <a href="#">
                    <img src="images/icon/logotri.png" alt="Cool Admin" />
                </a>
            </div>
                ...
                <nav class="navbar-sidebar2">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="has-sub">
                            ...
                            <i class="fas fa-archive"></i>Data Proyek</a>
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                                    <a href="?page=kelBarang">Semua Proyek</a>
                                </li>
                                <li>
                                    <a href="?page=periode">Lihat Proyek per Periode</a>
                                </li>
                                <li>
                                    <a href="?page=barangHabis">Proyek Selesai</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
                ...
                <div class="menu-sidebar2__content js-scrollbar2">
                    ...
                    <nav class="navbar-sidebar2">
                        <ul class="list-unstyled navbar__list">
                            ...
                            <li class="has-sub">
                                <a class="js-arrow" href="#">
                                    <i class="fas fa-tachometer-alt"></i>Data Proyek</a>
                                <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                    <li>
                                        <a href="?page=kelBarang">Semua Proyek</a>
                                    </li>
			...
			<?php 
				...
				switch($page){
                    ...
                    case 'profile':
                        ...
                        break;
                    case 'kelProyek':
                        include "manager/viewManagerProyek.php";
                        break;
                    case 'viewProyekDetail':
                        include "manager/viewProyekDetail.php";
                        break;
                    case 'periode':
                        include "manager/BarangPeriode.php";
                        break;
                    case 'ProyekSelesai':
                        include "manager/ProyekSelesai.php";
                        break;
                    case 'kelTransaksi':
