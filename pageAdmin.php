...
<body>
	...
	<div class="page-wrapper">
		<aside class="menu-sidebar2">
			<div class="logo">
                <a href="#">
                    <img src="images/icon/logotri.png" alt="" />
                </a>
            </div>
                ...
                <nav class="navbar-sidebar2">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            ...
                            <i class="fas fa-archive"></i>Jadwal Proyek</a>
                        </li>
                        <li>
                            <a href="?page=viewDistributor">
                            <i class="fas fa-users"></i>Data Customer</a>
                        </li>
                        <li>
                            <a href="?page=viewMerek">
                            <i class="fas fa-filter"></i>Data Pegawai</a>
                        </li>
                    </ul>
                </nav>
            </div>
		...
		<div class="page-container2">
			...
			<?php 
				...
				switch($page){
					case 'viewProyek':
						include "admin/viewProyek.php";
						break;
                    case 'viewCustomer':
                        include "admin/viewCustomer.php";
                        break;
                    case 'viewPegawai':
                        include "admin/viewPegawai.php";
                        break;
                    case 'addProyek':
                        include "admin/addProyek.php";
                        break;
                    case 'viewProyekDetail':
                        include "admin/viewProyekDetail.php";
                        break;
                    case 'viewProyekEdit':
                        include "admin/viewProyekEdit.php";
                        break;
                    case 'profile':
                        include "profile.php";
                        break;
